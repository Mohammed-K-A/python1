...
# def square(num):
#     return num**2
# object_=int(input("Enter a number: "))
# print("the square of the given number is:",square(object_))
...
# print("The sum of 2 numbers are :",square(a,b))
